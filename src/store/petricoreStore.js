...
const usePetricoreStore = create((set, get) => ({
  ...
  plan: {
    ...
    namePool: {
      ...
      names: [],
      origins: {
        european:       { enabled: true, weight: 1 },
        east_asian:     { enabled: true, weight: 1 },
        middle_eastern: { enabled: true, weight: 1 },
        african:        { enabled: true, weight: 1 },
        latin_american: { enabled: true, weight: 1 },
        slavic:         { enabled: true, weight: 1 },
        norse:          { enabled: true, weight: 1 },
        invented:       { enabled: true, weight: 1 },
      },
      genderSplit: { m: 40, f: 40, n: 20 },
      styles: {
        mythic:     { enabled: true, weight: 1 },
        grounded:   { enabled: true, weight: 1 },
        futuristic: { enabled: true, weight: 1 },
        gritty:     { enabled: true, weight: 1 },
      },
      nameInstructions: '',
    },
    storyStyles: {
